    ...
    const area = () => {
      ...
      const handleRegistrarArea = async (e) => {
        ...
        await fetch('http://localhost:4000/area/registrar', {
          method: 'POST',
          headers: {
      ...
      const handleActualizarArea = async () => {
        ...
        await fetch(`http://localhost:4000/area/actualizar/${areaActualizada.id_area}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
          },
          ...
          >
            {selectedArea ? (
              ...
              <div className="bg-white w-2/4 p-6 rounded shadow-lg grid grid-cols-2 gap-4">
                <h2 className="text-xl font-bold mb-4">Registrar Área</h2>
                <form>
                  <div className="mb-4">
                    <label htmlFor="nombre" className="block text-sm font-bold text-gray-700">
                      Nombre:
